...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        private void Update()
        {
            ...
            // 게임 종료 전까지 점프 비활성화, 물 속 점프 금지
            if (!m_Jump && gameEnd && this.transform.position.y > 2)
            {
        ...
        private void PlayFootStepAudio()
        {
            ...
            if(transform.position.y > 2) {
                ...
                // 위와 같은 로직으로, 수면 아래에 있을 때는 물소리 재생
        ...
        private void GetInput(out float speed)
        {
            ...
            // 수면보다 아래이면 달리기 불가, 속도 줄이기
            if (this.transform.position.y <= 2)
            {
                speed = 0.6f * m_WalkSpeed;
                m_IsWalking = true;
            }
        ...
        public void SetMouseLock(bool mode) {
            m_MouseLook.SetCursorLock(mode);
        }
    }
}
